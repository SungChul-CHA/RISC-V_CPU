...
#
# Generated by Vivado on Sat Oct 19 17:21:09 KST 2024
...
# Script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2022.2.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../rv32i.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../rv32i.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
