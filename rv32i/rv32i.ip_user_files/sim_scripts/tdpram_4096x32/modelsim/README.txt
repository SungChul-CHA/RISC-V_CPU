...
#
# Generated by export_simulation on Thu Oct 17 11:32:58 KST 2024
#
################################################################################
...
'-reset_run' switch to the './tdpram_4096x32.sh' script.

./tdpram_4096x32.sh -reset_run
...
./tdpram_4096x32.sh -noclean_files

For more information on the script, please type './tdpram_4096x32.sh -help'.
