...
HD_PWD='/home/tony/Desktop/riscv/rv32i/rv32i.runs/tdpram_4096x32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tdpram_4096x32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tdpram_4096x32.tcl
