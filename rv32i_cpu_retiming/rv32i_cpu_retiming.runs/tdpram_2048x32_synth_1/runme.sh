...
HD_PWD='/home/tony/Desktop/riscv/rv32i_cpu_retiming/rv32i_cpu_retiming.runs/tdpram_2048x32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tdpram_2048x32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tdpram_2048x32.tcl
