...
#
# Generated by export_simulation on Sun Oct 20 02:25:06 KST 2024
#
################################################################################
...
'-reset_run' switch to the './tdpram_2048x32.sh' script.

./tdpram_2048x32.sh -reset_run
...
./tdpram_2048x32.sh -noclean_files

For more information on the script, please type './tdpram_2048x32.sh -help'.
